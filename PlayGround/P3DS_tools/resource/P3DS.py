...
class Ui_P3DS_Launcher(object):
    def setupUi(self, P3DS_Launcher):
        ...
        self.CB_Compile_OC = CheckBox(self.GB_Check)
        font = QtGui.QFont()
        ...
        self.CB_Move = CheckBox(self.GB_Check)
        ...
        self.CB_Launch = CheckBox(self.GB_Check)
        font = QtGui.QFont()
        font.setFamily("Segoe UI")
        font.setPointSize(-1)
        font.setBold(False)
...
from qfluentwidgets import CheckBox, EditableComboBox, PrimaryPushButton, PushButton, TextEdit
