...
class PushButtonDemo(QWidget):
    ...
    def __init__(self):
        ...
        palette_list = [QColor(255, 0, 0), QColor(0, 255, 0), QColor(0, 0, 255),
                        QColor(255, 255, 0), QColor(255, 0, 255), QColor(0, 255, 255)]
        palette = QPalette()
        palette.setColor(QPalette.Button, palette_list[0])
        self.pushButton1.setPalette(palette)
        palette.setColor(QPalette.Button, palette_list[1])
        self.pushButton1.setPalette(palette)
